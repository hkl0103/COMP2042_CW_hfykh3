...
public class Wall {
     ...
     * @param brickDimensionRatio the ratio of the brick present (height & width)
     ...
     * @param brickSizeRatio ratio of the brick (height & width)
    ...
    /**
     * A mthod that function the movement of ball & paddle
     */
    public void move(){
        player.move();
        ball.move();
