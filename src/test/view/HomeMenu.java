...
public class HomeMenu extends JComponent implements MouseListener, MouseMotionListener {
     ...
     * @param owner Gameframe owner object
    ...
    private void drawButton(Graphics2D g2d) {
        ...
        //high score setting ends

    }

    /**
     * A method that draws the implements homemenu when clicked
    ...
    public void mouseClicked(MouseEvent mouseEvent) {
        ...
        if(startButton.contains(p)){
           owner.enableGameBoard();
            //MusicPlayer player = new MusicPlayer("backgroundmusic.wav");
            //player.stopSound();
        }
    ...
    public void mouseMoved(MouseEvent mouseEvent) {
        Point p = mouseEvent.getPoint();
        if(startButton.contains(p) || menuButton.contains(p) || infoButton.contains(p)|| scoreButton.contains(p))
